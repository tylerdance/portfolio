function About() {
    return(
        <div id="about-parent-div">
            ...
            <div class="skills">
                <h4 id="skills-header">Tool Box</h4>
