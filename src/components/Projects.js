            ...
            <div class="projects">
                <div id="projects-margin">
                    <div>
                        ...
                        <p class="projects-info"><a class="projects-info" href="https://github.com/tylerdance/lol-report-backend" target="_blank" rel="noreferrer">back end repo</a></p>
                    </div>
                    <div>
                        ...
                        <p class="projects-info-name"><a class="projects-info" href="http://token-chat.herokuapp.com/" target="_blank" rel="noreferrer">Token</a></p>
                        <p class="projects-info"><a class="projects-info" href="https://github.com/tylerdance/SEI-project4-frontend" target="_blank" rel="noreferrer">front end repo</a></p>
                        <p class="projects-info"><a class="projects-info" href="https://github.com/tylerdance/SEI-project4-backend" target="_blank" rel="noreferrer">back end repo</a></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="projects-info-name"><a class="projects-info" href="http://tabsensei.herokuapp.com/" target="_blank" rel="noreferrer">Tab Sensei</a></p>
                        <p class="projects-info"><a class="projects-info" href="https://github.com/tylerdance/tab-sensei-frontend" target="_blank" rel="noreferrer">front end repo</a></p>
                        <p class="projects-info"><a class="projects-info" href="https://github.com/tylerdance/tab-sensei-backend" target="_blank" rel="noreferrer">back end repo</a></p>
                    </div>
                    <div>
                        ...
                        <p class="projects-info-name"><a class="projects-info" href="http://off-road-trail-finder.herokuapp.com/" target="_blank" rel="noreferrer">Trail Hunter</a></p>
                    ...
                    <div id="asteroids-pic">
                        ...
                        <p class="projects-info-name"><a class="projects-info" href="http://tylerdance.github.io/Asteroids-game/" target="_blank" rel="noreferrer">Asteroids</a></p>
